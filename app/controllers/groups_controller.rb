class GroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group.save
        format.html { redirect_to house_group_url, notice: 'Group was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @group.update(group_params)
        format.html { redirect_to house_group_url, notice: 'Group was successfully updated.' }
